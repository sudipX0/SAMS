...
<head>
  ...
  <style>    
    .trainers .member img {
      width: 150px; /* Reduce the image size in the trainer section */
      height: 150px;
      object-fit: cover;
    }
  </style>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.php">SAMS</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="index2.php">Login</a> 
          </li>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Key Features</h2><!-- Log on to freeprojectscodes.com for more projects! -->
          <p>What SAMS Offer ?</p>
        </div>

        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/img/ams.png" style="height:400px;" class="img-fluid" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            ...
            <p>Session</p><!-- Log on to freeprojectscodes.com for more projects! -->
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/team/lana.png" class="img-fluid" alt="">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Email:</strong> mail@sams.com<br>
            </p>
          </div>
